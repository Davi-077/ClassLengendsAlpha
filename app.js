...
const characters = [
  {id:"guerreiro_1", name:"Guerreiro 1", cls:"Guerreiro", css:"guerreiro", image:"assets/characters/guerreiro-1.png"},
  {id:"guerreiro_2", name:"Guerreiro 2", cls:"Guerreiro", css:"guerreiro", image:"assets/characters/guerreiro-2.png"},
  {id:"ninja_1", name:"Ninja 1", cls:"Ninja", css:"ninja", image:"assets/characters/ninja-1.png"},
  {id:"ninja_2", name:"Ninja 2", cls:"Ninja", css:"ninja", image:"assets/characters/ninja-2.png"},
  {id:"pirata_1", name:"Pirata 1", cls:"Pirata", css:"pirata", image:"assets/characters/pirata-1.png"},
  {id:"pirata_2", name:"Pirata 2", cls:"Pirata", css:"pirata", image:"assets/characters/pirata-2.png"},
  {id:"fada_1", name:"Fada 1", cls:"Fada", css:"fada", image:"assets/characters/fada-1.png"},
  {id:"fada_2", name:"Fada 2", cls:"Fada", css:"fada", image:"assets/characters/fada-2.png"},
  {id:"medico_1", name:"Médico 1", cls:"Médico", css:"medico", image:"assets/characters/medico-1.png"},
  {id:"medico_2", name:"Médico 2", cls:"Médico", css:"medico", image:"assets/characters/medico-2.png"},
];
...
function renderStart(){
  app.innerHTML = `
    <section class="visual-screen start-visual">
      <button class="visual-play-button" id="playBtn" aria-label="Jogar">JOGAR</button>
    </section>`;
...
function renderAuth(message="", type=""){
  ...
  app.innerHTML = `<div class="login-visual"><div class="shell"><section class="card login-card">\n      ${logo()}\n      <div class="tabs">
